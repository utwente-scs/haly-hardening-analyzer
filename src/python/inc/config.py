...
class Config(object):
    ...
    def from_dict(self, data: dict):
        ...
        for key in ['logging', 'dump_timeout', 'radare_timeout', 'radare_memory_limit', 'radare_servers', 'dynamic_analysis_timeout', 'dynamic_analysis_ios_start_timeout', 'uninstall_apps', 'network_adapter', 'ips', 'play_store_email', 'play_store_aastoken', 'app_store_email', 'app_store_password', 'android_abi']:
            if key in data:
