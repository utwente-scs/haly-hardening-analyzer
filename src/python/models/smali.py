...
class Smali:
    ...
    def find_call(self, method_name: str, type: str = 'method', include_comparisons: bool = False) -> list[object]:
        """
            ...
            if line.startswith('invoke-'):
                ...
                if include_comparisons:
                    ...
                    for comparison_fun in comparison_funs:
                        ...
                        smali_args = [arg.strip() for arg in matches.group(2).split(',')]
                        if smali_args[0] in return_registries and smali_args[1] in registry:
